    ...
    */
    ...
    else
    {
        ...
        else//需要升级设置
        {
            ...
            {
                v6();
                isn2('zhsvpap','Boolean',settings);
                isn2('zhsshowvc','Boolean',settings);
            ...
            {
                v8();
                isn2('huo','Boolean',settings);
                isn2('fuo','Boolean',settings);
            }
            ...
            if(comv(sv,[1,0,13])==1&&comv(sv,[1,0,17])==-1)
            {
                need=true;
                getnews();
                v7();
            ...
            if(comv(sv,[1,0,22])==1&&comv(sv,[1,1,0])==-1)
            {
                need=true;
                getnews();
                v9();
            }
            if(!comv(sv,[1,1,0])||(comv(sv,[1,1,0])==1&&comv(sv,[1,1,4]==-1)))equalnow();
        }
    }
    if(need)
    {
